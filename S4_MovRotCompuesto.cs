...
public class S4_MovRotCompuesto : MonoBehaviour
{
    ...
    [SerializeField] float velocidad_rotacion = 200f;
    [SerializeField] float velocidad_movimiento = 1f;
    void Start()
    {
    ...
    void Update()
    {
        ...
        float angulo  = 70f * Time.deltaTime;
        // x y z
    if(Input.GetKey(KeyCode.Q)){
        ...
        if(Input.GetKey(KeyCode.W)){
            ...
            // transform.position += transform.forward * velocidad_movimiento * -1 * Time.deltaTime;
